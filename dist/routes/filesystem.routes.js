...
export function createFileSystemRoutes(fileSystemService) {
    ...
    router.get('/list', async (req, res, next) => {
        ...
        try {
            ...
            const result = await fileSystemService.listDirectory(req.query.path, recursive, respectGitignore);
