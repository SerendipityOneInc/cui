...
export class WebPushService {
    ...
    prepareStatements() {
        this.insertStmt = this.db.prepare('INSERT OR REPLACE INTO subscriptions (endpoint, p256dh, auth, user_agent, created_at, last_seen, expired) VALUES (?, ?, ?, ?, COALESCE((SELECT created_at FROM subscriptions WHERE endpoint = ?), ?), ?, 0)');
    ...
    addOrUpdateSubscription(subscription, userAgent = '') {
