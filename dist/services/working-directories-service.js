export class WorkingDirectoriesService {
    historyReader;
    logger;
    constructor(historyReader, logger) {
    ...
    computeShortnames(paths) {
        ...
        for (const { path, segments } of pathSegments) {
            ...
            while (suffixLength <= segments.length) {
                ...
                const isUnique = pathSegments.every(other => other.path === path ||
...
//# sourceMappingURL=working-directories-service.js.map