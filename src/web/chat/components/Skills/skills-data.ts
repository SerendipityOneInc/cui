...
export const FEATURED_SKILLS: Skill[] = [
  {
    ...
    prompt: '/nano-banana Generate an image: [describe what you want - style, mood, colors, composition]',
    source: 'builtin',
  },
  {
    id: 'lark-docs',
  ...
  },
  {
    ...
    prompt: '/publish-html-page Create a webpage for [describe your website]',
    source: 'builtin',
  },
];
...
export const EXTENDED_SKILLS: Skill[] = [
  ...
  // --- Creative ---
  {
    ...
    prompt: '/nano-banana Design an app icon for [your app name/description], minimalist style',
    source: 'builtin',
  },
  {
    ...
    prompt: '/nano-banana Create a YouTube thumbnail for a video about [your video topic], eye-catching and bold',
    source: 'builtin',
  },
  // --- Web & Marketing ---
  {
    ...
    prompt: '/publish-html-page Create a high-converting landing page for [your product/service], targeting [your audience]',
    source: 'builtin',
  },
  {
    ...
    prompt: '/marketing-fundamentals Develop a marketing strategy for [your product/service], including positioning, channels, and growth tactics',
    source: 'builtin',
  },
];
